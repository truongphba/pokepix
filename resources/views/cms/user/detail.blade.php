    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <div class="row">
                    <h4 class="m-0 font-weight-bold text-primary">User Detail</h4>
                </div>
            </div>
            <div class="card-body">
                ...
                <div class="form-group" style="display: flex">
                    ...
                    <a href="/cms/users/{{ $item->id }}/edit">
                        ...
                        <button type="button" class="btn btn-danger text-uppercase mr-2"  data-toggle="modal" data-target="#delete-confirm">Delete</button>
